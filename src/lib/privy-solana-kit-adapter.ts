...
export function createPrivySolanaKitSigner(privyWallet: any): KeyPairSigner {
  ...
  return {
    ...
    // The signMessage method for @solana/kit KeyPairSigner
    signMessage: async (message: SignableMessage): Promise<Uint8Array> => {
      // For Solana Kit, signMessage typically expects a Uint8Array message
